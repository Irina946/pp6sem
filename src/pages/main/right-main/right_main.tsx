      ...
      {isOpenDescription && (<div
        ...
        <div className={styles.modalDescription}>
          ...
          <div className={styles.descriptionModal}>
            Автоматизированный инструмент для генерации уникальных контрольных заданий по математике,
            обеспечивающий разнообразие и адаптивность материалов для разных уровней сложности и тематик
          </div>
        </div>
      </div>)}
